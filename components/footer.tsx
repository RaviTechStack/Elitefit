...
export default function Footer() {
  return (
    <footer className="w-full border-t border-zinc-800 dark:bg-black bg-zinc-50 py-6 md:py-12">
      <div className="container grid grid-cols-1 md:grid-cols-4 gap-8 px-4 md:px-6">
        <div className="space-y-4">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            Premium fitness coaching for transformative results. Personalized training and nutrition plans for your
            unique goals.
          </p>
        </div>
        <div className="space-y-4">
          ...
          <nav className="flex flex-col space-y-2">
            <Link href="/" className="text-sm text-zinc-500 dark:text-zinc-400 hover:text-blue-400 transition-colors">
              Home
            </Link>
            <Link
              href="/trainer"
        ...
        <div className="space-y-4">
          ...
          <nav className="flex flex-col space-y-2">
            <Link
              href="/services?service=strength"
              className="text-sm text-zinc-500 dark:text-zinc-400 hover:text-blue-400 transition-colors"
            >
              Strength Training
            </Link>
            <Link
              href="/services?service=fat-loss"
              className="text-sm text-zinc-500 dark:text-zinc-400 hover:text-blue-400 transition-colors"
            >
              Fat Loss
            </Link>
            <Link
              href="/services?service=nutrition"
              className="text-sm text-zinc-500 dark:text-zinc-400 hover:text-blue-400 transition-colors"
            >
              Nutrition Planning
            </Link>
            <Link
              href="/services?service=online"
              className="text-sm text-zinc-500 dark:text-zinc-400 hover:text-blue-400 transition-colors"
            >
              Online Coaching
            </Link>
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-4">
            <Link href="#" className="text-zinc-500 dark:text-zinc-400 hover:text-blue-400">
      ...
      <div className="container mt-8 pt-8 border-t border-zinc-800">
